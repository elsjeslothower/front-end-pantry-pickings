      ...
      <div className="card-body" style={{color:"darksalmon"}}>
        ...
        <p className="card-text">
          <ul className="list-group list-group-flush" style={{color:"bisque", background:"bisque"}}>
            <li className="list-group-item" style={{color:"bisque", background:"darksalmon"}}>Intolerances: {props.intolerances}</li>
            <li className="list-group-item" style={{color:"bisque", background:"darksalmon"}}>Dietary Preferences: {props.dietary_preferences}</li>
            <li className="list-group-item" style={{color:"bisque", background:"darksalmon"}}>Notes: {props.notes}</li>
          </ul>
        </p>
        <a onClick={handleUpdateContact} class="card-link">Edit Contact</a>
        <a onClick={handleDeleteContact} class="card-link">Delete Contact</a>
      </div>
    </div>
  );
};
